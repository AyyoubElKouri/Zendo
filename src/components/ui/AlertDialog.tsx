...
function ConfirmationAlert({
   ...
   return (
      <AlertDialog>
         ...
         <AlertDialogContent className='w-100 h-50 bg-background-1 border-1 border-border p-10'>
            <AlertDialogHeader>
            ...
            <AlertDialogFooter className='flex justify-start items-center'>
               ...
               <AlertDialogAction
                  onClick={action}
                  className='max-w-40 max-h-10 rounded-large border-1 border-border bg-accent text-white hover:bg-accent/80'
               >
                  Confirm
               </AlertDialogAction>
            </AlertDialogFooter>
